import { Tensor, TensorLike, tensor, zeros, moments, ones } from '@tensorflow/tfjs-node';
...
export class LogisticRegression {
  ...
  constructor(features: TensorLike, labels: TensorLike, options: Object) {
  ...
  processFeatures(features: TensorLike) {
  ...
  predict(observations: TensorLike) {
  ...
  test(testFeatures: TensorLike, testLabels: TensorLike) {
