...
export function convertToTensor(data, featureColumns, labelColumns, testSplit) {
    return tf.tidy(() => {
...
export function standardize(data, mean, variance) {
...
export async function trainModel(model, features, labels, batchSize, epochs) {
    model.compile({
...
export function testModel(model, testFeatures, testLabels) {
    const preds = model.predict(testFeatures);
...
export async function buildAndTestModel(features, labels, testFeatures, testLabels, normalizeData, batchSize, epochs) {
...
export async function buildBestModel(features, labels, testFeatures, testLabels, batchLimit, epochLimit) {
...
export function predict(model, features, mean, variance) {
